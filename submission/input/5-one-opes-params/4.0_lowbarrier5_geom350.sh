...
# tag for system
export TAG_JOBID="5.4.0" # tag to append to system name
...
export ONEOPES_REPLICA_3_TEMP='309' # [K] max OPES MultiTherm temperature of replica 3
export ONEOPES_REPLICA_4_TEMP='319' # [K] max OPES MultiTherm temperature of replica 4
export ONEOPES_REPLICA_5_TEMP='329' # [K] max OPES MultiTherm temperature of replica 5
export ONEOPES_REPLICA_6_TEMP='339' # [K] max OPES MultiTherm temperature of replica 6
export ONEOPES_REPLICA_7_TEMP='350' # [K] max OPES MultiTherm temperature of replica 7
