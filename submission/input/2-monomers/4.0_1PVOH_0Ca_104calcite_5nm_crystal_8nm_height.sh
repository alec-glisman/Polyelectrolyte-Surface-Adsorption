...
export PIN_OFFSET='18' # offset for CPU thread pinning (-1 = no offset)
...
export MONOMER="Alc" # Dominant monomer: {Acr, Acn, Asp, Glu, Ace, Alc}
...
# tag for system
export TAG_JOBID="2.4.4" # tag to append to system name
