...
#SBATCH --job-name=Eqbm-1.4.3-1.4.4
...
input_globals=(
    # '4.1_16PAA_0Ca_104calcite_9nm_crystal_10nm_height.sh'
    # '4.2_16PAA_0Ca_104calcite_9nm_crystal_10nm_height.sh'
    '4.3_16PAA_0Ca_104calcite_9nm_crystal_10nm_height.sh'
    '4.4_16PAA_0Ca_104calcite_9nm_crystal_10nm_height.sh'
)
...
parallel --link --keep-order --ungroup --halt-on-error '2' --jobs '2' \
