...
c_compiler="/usr/bin/gcc"   # OPTIONS: [gcc, icc, mpicc]
cxx_compiler="/usr/bin/g++" # OPTIONS: [g++, icpc, mpic++]
...
install_dir="/nfs/zeal_nas/home_mount/modules/plumed_${plumed_version}-${compilers}"
