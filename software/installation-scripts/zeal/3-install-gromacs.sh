...
cmake_install="${module_root}/gromacs_mpi_${gromacs_version}-plumed_mpi_${plumed_version}-${compilers}"

# PLUMED path variables
plumed_exe="${module_root}/plumed_mpi_${plumed_version}-${compilers}/bin/plumed"
